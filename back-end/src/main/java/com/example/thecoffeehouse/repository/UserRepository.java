...
public interface UserRepository extends JpaRepository<User, Long>{
    @Query("SELECT new com.example.thecoffeehouse.dto.UserDto(u.id, u.name, u.phoneNumber, u.email, u.avatar, u.gender, u.createTime, u.modifyTime, r.name, r.removable) " +
            "FROM User u " +
