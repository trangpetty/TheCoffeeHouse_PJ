...
//                                .requestMatchers("/api/vouchers/**").hasAnyAuthority(Role.USER.name())
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://10.30.100.178:8081", "http://localhost:8081", "http://localhost:3000", "http://192.168.0.100:8081", "http://172.20.10.4:8081"));
