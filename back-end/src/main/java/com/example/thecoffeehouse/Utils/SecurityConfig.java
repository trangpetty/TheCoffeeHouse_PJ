...
//        configuration.setAllowedOrigins(Arrays.asList("http://192.168.0.104:8081"));
        configuration.setAllowedOrigins(Arrays.asList("http://10.30.100.178:8081", "http://localhost:8081"));
